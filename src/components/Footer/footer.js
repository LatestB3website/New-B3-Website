        ...
        <div class="footer-content-column">
          <div class="footer-logo">
            <a class="footer-logo-link" href="/">
              {/* <span class="hidden-link-text">B3 Solutions</span> */}
            {/* <h1 className='footer-logo-link'> B3 Solutions </h1> */}
            <img src={Imagelogo} alt="Imagelogo"
   style={{width: "80px",height:"80px", display:'flex' ,shapeOutside:'border-box'}}/>
          ...
          <div class="footer-menu">
            ...
            <ul id="menu-company" class="footer-menu-list">
              ...
              <li id="menu-item-167409" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-167409">
                <a href="/technology-clients">Technology Clients</a>
                <br></br> </li>
              <li id="menu-item-167409" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-167409">
              <a href="/recruitment-clients">Recruitment Clients</a>
              <br></br> </li>
          ...
          <div class="footer-menu">
            ...
            <ul id="menu-quick-links" class="footer-menu-list">
              <li id="menu-item-168092" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-168092">
                <a target="_blank" rel="noopener noreferrer" href="/technology-services">Technology Services</a>
             <br></br> </li>
              <li id="menu-item-167418" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-167418">
                <a target="_blank" rel="noopener noreferrer" href="/recruitment-services">Recruitment Services</a>
                <br></br> </li>
        ...
        <div class="footer-content-column">
          ...
          <div class="footer-call-to-action">
            ...
            <p class="footer-call-to-action-link-wrapper"> <a class="footer-call-to-action-link" href="tel:0124-64XXXX" target="_self"> (+91) 022 65510355   </a></p>
            
          </div>
          <div class="footer-call-to-action">
            <h2 class="footer-call-to-action-title"> Address</h2>
            <p><br/>912| 1st Floor| Building No 9 |Solitaire     Corporate Park| Andheri Kurla Road | Chakala | Andheri (East) | Mumbai -
             400 093 </p>
      ...
      <div class="footer-copyright">
        <div class="footer-copyright-wrapper">
          <p class="footer-copyright-text">
            <a class="footer-copyright-link" href="/" target="_self" > ©2021. | BitByBit Solutions. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
