    ...
    return (
      <div className="flex flex-col items-center min-h-screen bg-gray-100">
        ...
        Web Development
          ...
          <div className="bg-white parentDiv w-[90%] parentDiv relative left-20 shadow-2xl  p-6 rounded-xl mb-5 transform transition-all  border ">
        ...
        >
          ...
          <div className="bg-white parentDiv w-[90%]   relative left-20  shadow-2xl p-6 rounded-2xl  transform transition-all  border ">
            <div className="flex flex-col h-80 items-start">
              <h4 className="heading smallcontaint pl-6">
