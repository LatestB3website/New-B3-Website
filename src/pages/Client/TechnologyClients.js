...
import suntrap from '../../assets/images/suntrap.png'
      ...
      <div className="clientHero" >
        ...
        <div className="clientContent">
          <div className='clientTitle'>
            <h4>Our Clients Trust Us
            </h4>
            <p>We did a great job with these companies.<br/> You can be Next.</p>
          </div>
        </div>
        ...
        <div className='clientSecondSection'>
          ...
          <div className="clientRow1">
            ...
            <TiltCard image={hamarakendra}></TiltCard>
            <TiltCard image={suntrap}></TiltCard>
          </div>
...
export default TechnologyClients;